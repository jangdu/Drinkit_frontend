...
const AddPoint = (user) => {
  ...
  return (
    <div>
      <h2 className="mb-5 mx-auto text-xl font-bold text-center">포인트 충전</h2>
      <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
        <input
          ...
          placeholder="충전 금액"
          value={cost}
          onChange={(e) => {setCost(e.target.value); setIsButton(false);}}
        />
        <p className="flex justify-end text-slate-400 text-xs">1회 충전 한도는 1,000,000원 입니다.</p>
        <button
          type="submit"
