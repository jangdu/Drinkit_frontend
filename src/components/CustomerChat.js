...
export default function CustomerChat() {
  ...
  const clearChat = () => {
    localStorage.removeItem('saveBar')
    setSave("")
    setChainMessage("")
    setMessage("")
    setloading(false)
  ...
  return (
    <div className="h-[75%]">
      ...
      <div className="flex flex-col items-end mt-1 mb-1">
        <button className="pl-2 pr-2 text-lg rounded-tr-md mr-2 bg-pink-300 rounded-xl titleFont shadow-sm shadow-pink-400 hover:bg-pink-400 hover:shadow-none" onClick={() => {clearChat()}}>대화내용삭제</button>
      </div>
